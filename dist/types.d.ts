...
export interface RuntimeCommandContext {
    ...
    assignShellVariable?: (name: string, value: string, subscript?: string) => void | Promise<void>;
    /**
    ...
    execWithInheritedStdin?: (command: string, options: Omit<CommandExecOptions, "stdin" | "stdinKind">) => Promise<ExecResult>;
    /**
...
export type CommandContext = Omit<RuntimeCommandContext, "limits" | "executionScope"> & {
