 ...
 */
export declare function decodeBytesToUtf8(b: ByteString, maxBytes?: number): string;
/**
 ...
 */
export declare function encodeUtf8ToBytes(s: string, maxBytes?: number): ByteString;
 ...
 */
export declare function bytesFromUint8Array(buf: Uint8Array, maxBytes?: number): ByteString;
/**
