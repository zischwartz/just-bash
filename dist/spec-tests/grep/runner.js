 ...
 */
export async function runGrepTestCase(testCase, options = {}) {
    ...
    // Create files object
    const files = Object.assign(Object.create(null), { "/tmp/_keep": "" });
    ...
    try {
        ...
        const exitCodeMatches = expectedExitCode === undefined || actualExitCode === expectedExitCode;
