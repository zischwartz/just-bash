...
import type { CommandExecOptions, CommandRegistry, ExecResult, FeatureCoverageWriter, TraceCallback } from "../types.js";
...
export interface InterpreterContext {
    ...
    execFn: (script: string, options?: InterpreterExecOptions, stdinAlreadyAccounted?: boolean) => Promise<ExecResult>;
     ...
     */
    executeCommand: (node: CommandNode, stdin: string, stdinOwned?: boolean) => Promise<ExecResult>;
