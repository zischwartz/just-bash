 ...
 */
import { getArrayElement, getArrayIndices, getAssocArrayKeys, hasArray, } from "../helpers/array.js";
...
export function listIndexedArrays(ctx) {
    ...
    const arrayNames = new Set(Array.from(ctx.state.arrays ?? [])
