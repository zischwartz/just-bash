...
import { compareCanonicalContainment, compareFileIdentity, FileTraversalBudget, traverseFileTree, } from "../../fs/traversal.js";
        ...
        for (const src of sources) {
            try {
                ...
                if (srcStat.isDirectory) {
                    const containment = await compareCanonicalContainment(ctx.fs, srcPath, targetPath, traversalBudget);
                    if (isSameOrDescendantPath(srcPath, targetPath) ||
                        containment === "inside") {
