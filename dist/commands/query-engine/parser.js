...
class Parser {
    ...
    pos = 0;
    depth;
    constructor(tokens, maxDepth, initialDepth = 0) {
...
export function parse(input, limits = {}) {
    ...
    if (input.length > maxSourceLength) {
        throw new Error(`query source length limit exceeded (${maxSourceLength} characters)`);
    }
