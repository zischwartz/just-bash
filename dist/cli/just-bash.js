...
function parseArgs(args) {
    ...
    const rejectPositionals = (message) => {
...
async function main() {
    ...
    if (options.script) {
        ...
        try {
            ...
            console.error(sanitizeErrorMessage(e instanceof Error ? e.message : String(e)));
            process.exit(1);
        }
    }
...
main().catch((e) => {
    console.error("Fatal error:", sanitizeErrorMessage(e instanceof Error ? e.message : String(e)));
    process.exit(1);
});
