 ...
 */
let blockedGlobalViolationTypes;
export function getBlockedGlobalViolationTypes() {
    if (!blockedGlobalViolationTypes)
        getBlockedGlobals();
...
export function getBlockedGlobals() {
    ...
    blockedGlobalViolationTypes ??= new Set(availableGlobals.map(({ violationType }) => violationType));
